...
{
    /* Saber a quién se le asignará ese elemento */
...
int Shader::GetUniformLocation(const std::string& name)
{
    ...
    /* Posición de dónde estamos utilizando esta uniform ocn ese nombe en específico, para saber en dónde en el Shader se va a modificar */
    return location; 
}